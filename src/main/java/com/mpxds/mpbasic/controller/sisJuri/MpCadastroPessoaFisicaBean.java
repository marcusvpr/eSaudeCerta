...
public class MpCadastroPessoaFisicaBean implements Serializable {
	...
	public void onCepWebService() {
    	//
		MpCepXML mpCepXML = MpClienteWebService.executaCep(this.mpPessoaFisica.getMpEnderecoLocalX().getCep());
		if (null == mpCepXML)
...
//				this.mpPessoaFisica.getMpEnderecoEntrega().getCep() + " / " + mpCepXML.getLogradouro());
			//
			this.mpPessoaFisica.getMpEnderecoLocalX().setLogradouro(mpCepXML.getLogradouro());
			this.mpPessoaFisica.getMpEnderecoLocalX().setComplemento(mpCepXML.getComplemento());
			this.mpPessoaFisica.getMpEnderecoLocalX().setBairro(mpCepXML.getBairro());
			this.mpPessoaFisica.getMpEnderecoLocalX().setCidade(mpCepXML.getCidade());
			// Trata UF! ...
			...
			this.mpPessoaFisica.getMpEnderecoLocalX().setMpEstadoUF(mpEstadoUF);
			//
		}
    }
...
//    	MpAppUtil.PrintarLn("MpCadastroCliente.findByNome() = TRUE");
	...
	private void limpar() {
		...
		this.mpPessoaFisica.setMpEnderecoLocalX(mpEnderecoLocalX);
		//
		this.limparArquivo();
	}
