...
public class MpCadastroPessoaJuridicaBean implements Serializable {
	...
	private MpEnderecoLocalX mpEnderecoLocalX = new MpEnderecoLocalX();
	...
	public void onCepWebService() {
    	//
		MpCepXML mpCepXML = MpClienteWebService.executaCep(this.mpPessoaJuridica.getMpEnderecoLocalX().getCep());
		if (null == mpCepXML)
			MpFacesUtil.addErrorMessage("CEP WebService... sem retorno !");
		else {
			//
			this.mpPessoaJuridica.getMpEnderecoLocalX().setLogradouro(mpCepXML.getLogradouro());
			this.mpPessoaJuridica.getMpEnderecoLocalX().setComplemento(mpCepXML.getComplemento());
			this.mpPessoaJuridica.getMpEnderecoLocalX().setBairro(mpCepXML.getBairro());
			this.mpPessoaJuridica.getMpEnderecoLocalX().setCidade(mpCepXML.getCidade());
			// Trata UF! ...
			...
			this.mpPessoaJuridica.getMpEnderecoLocalX().setMpEstadoUF(mpEstadoUF);
			//
		}
    }
...
//    	MpAppUtil.PrintarLn("MpCadastroCliente.findByNome() = TRUE");
	...
	private void limpar() {
		...
		//
		this.mpEnderecoLocalX = new MpEnderecoLocalX();

		this.mpEnderecoLocalX.setCep("");
		this.mpEnderecoLocalX.setLogradouro("");
		this.mpEnderecoLocalX.setBairro("");
		this.mpEnderecoLocalX.setComplemento("");
		this.mpEnderecoLocalX.setNumero("");
		
		this.mpPessoaJuridica.setMpEnderecoLocalX(mpEnderecoLocalX);
		//
		this.limparArquivo();
	}
