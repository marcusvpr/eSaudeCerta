...
public class MpCadastroTabelaInternaSJBeanY implements Serializable {
	...
	public void mpFirst() {
		//
		this.mpTabelaInternaSJ = this.mpTabelaInternaSJs.porNavegacao("mpFirst", MpTipoTabelaInternaSJ.TAB_0000, " "); 
		if (null == this.mpTabelaInternaSJ) {
...
//															this.mpTabelaInternaSJ.getDescricao());
	...
	public void mpPrev() {
		...
		this.mpTabelaInternaSJ = this.mpTabelaInternaSJs.porNavegacao("mpPrev",
													mpTabelaInternaSJ.getMpTipoTabelaInternaSJ(),
	...
	public void mpEnd() {
		//
		this.mpTabelaInternaSJ = this.mpTabelaInternaSJs.porNavegacao("mpEnd", MpTipoTabelaInternaSJ.TAB_1070, "ZZZZZ"); 
		if (null == this.mpTabelaInternaSJ)
			this.limpar();
		else {
			this.mpTabelaInternaSJPai = this.mpTabelaInternaSJ.getMpPai();
