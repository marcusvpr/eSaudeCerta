...
//				}
	...
	public void trataClienteSJ() {
		...
		try {
			...
			MpEnderecoLocalX mpEnderecoLocalX = new MpEnderecoLocalX();
			//
			while (resultSet.next()) {
				//
				id = Long.parseLong(resultSet.getString("id"));
...
//				if (null == mpClienteSJ) { 
				MpClienteSJ mpClienteSJ = new MpClienteSJ();
					...
					mpEnderecoLocalX = new MpEnderecoLocalX();
					mpEnderecoLocalX.setLogradouro("");
					mpEnderecoLocalX.setNumero("");
					mpEnderecoLocalX.setComplemento("");
					mpEnderecoLocalX.setCidade("");
					mpEnderecoLocalX.setBairro("");
					mpEnderecoLocalX.setCep("");
					mpEnderecoLocalX.setMpEstadoUF(MpEstadoUF.XX);
					
					mpClienteSJ.setMpEnderecoLocalX(mpEnderecoLocalX);						
//				}
...
//				if (null == mpPessoaFisica) { 
					...
					mpPessoaFisica.setMpEnderecoLocalX(mpEnderecoLocalX);					
//				}
...
//				if (null == mpPessoaJuridica) { 
					...
					mpPessoaJuridica.setMpEnderecoLocalX(mpEnderecoLocalX);					
//				}
