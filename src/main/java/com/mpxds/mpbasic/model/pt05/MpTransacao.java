...
public class MpTransacao extends MpBaseEntity {
	...
	private String nomSacador;
	private String documentoSacador;
	private String enderecSacador;
	private String cepSacador;
	private String cidadSacador;
	...
	public void setAgenciaCodCedente(String agenciaCodCedente) {
	...
	public void setNomeCedFav(String nomeCedFav) { this.nomeCedFav = nomeCedFav; }
  	...
  	@Column(name = "nom_sacador", nullable = false, length = 45)
	public String getNomSacador() { return nomSacador; }
	public void setNomSacador(String nomSacador) { this.nomSacador = nomSacador; }
	...
	public void setDocumentoSacador(String documentoSacador) { 
  	...
  	@Column(name = "enderec_sacador", nullable = false, length = 45)
	public String getEnderecSacador() { return enderecSacador; }
	public void setEnderecSacador(String enderecSacador) { this.enderecSacador = enderecSacador; }
	...
	public void setCepSacador(String cepSacador) { this.cepSacador = cepSacador; }
  	...
  	@Column(name = "cidad_sacador", nullable = false, length = 20)
	public String getCidadSacador() { return cidadSacador; }
	public void setCidadSacador(String cidadSacador) { this.cidadSacador = cidadSacador; }
	...
	public void setTipoIdentDevedor(String tipoIdentDevedor) { 
	...
	public void setSeloDistribuidor(String seloDistribuidor) {
