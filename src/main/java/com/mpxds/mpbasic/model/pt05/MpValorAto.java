...
public class MpValorAto implements Serializable {
	...
	@Column(name = "valor_ato_emolumento", nullable = false, precision = 10, scale = 2)
	...
	@Column(name = "valor_ato_variavel", nullable = false, precision = 10, scale = 2)
	public BigDecimal getValorAtoVariavel() { return valorAtoVariavel; }
	public void setValorAtoVariavel(BigDecimal valorAtoVariavel) {
														this.valorAtoVariavel = valorAtoVariavel; }
	
	@Column(name = "valor_ato_lei3271", nullable = false, precision = 10, scale = 2)
	public BigDecimal getValorAtoLei3217() { return valorAtoLei3217; }
	public void setValorAtoLei3217(BigDecimal valorAtoLei3217) {
														this.valorAtoLei3217 = valorAtoLei3217; }
	
	@Column(name = "valor_ato_lei4664", nullable = false, precision = 10, scale = 2)
	public BigDecimal getValorAtoLei4664() { return valorAtoLei4664; }
	public void setValorAtoLei4664(BigDecimal valorAtoLei4664) {
														this.valorAtoLei4664 = valorAtoLei4664; }
	
	@Column(name = "valor_ato_lei111", nullable = false, precision = 10, scale = 2)
	public BigDecimal getValorAtoLei111() { return valorAtoLei111; }
	public void setValorAtoLei111(BigDecimal valorAtoLei111) {
															this.valorAtoLei111 = valorAtoLei111; }
	
	@Column(name = "valor_ato_lei3761", nullable = false, precision = 10, scale = 2)
	public BigDecimal getValorAtoLei3761() { return valorAtoLei3761; }
	public void setValorAtoLei3761(BigDecimal valorAtoLei3761) {
														this.valorAtoLei3761 = valorAtoLei3761; }
	
	@Column(name = "valor_ato_lei590", nullable = false, precision = 10, scale = 2)
	public BigDecimal getValorAtoLei590() { return valorAtoLei590; }
	public void setValorAtoLei590(BigDecimal valorAtoLei590) {
															this.valorAtoLei590 = valorAtoLei590; }
	
	@Column(name = "valor_ato_lei6281", nullable = false, precision = 10, scale = 2)
	public BigDecimal getValorAtoLei6281() { return valorAtoLei6281; }
	public void setValorAtoLei6281(BigDecimal valorAtoLei6281) {
														this.valorAtoLei6281 = valorAtoLei6281; }
	
	@Column(name = "valor_ato_distribuicao", nullable = false, precision = 10, scale = 2)
	...
	@Column(name = "valor_ato_lei713", nullable = false, precision = 10, scale = 2)
	public BigDecimal getValorAtoLei713() { return valorAtoLei713; }
	public void setValorAtoLei713(BigDecimal valorAtoLei713) {
															this.valorAtoLei713 = valorAtoLei713; }
	
	@Column(name = "valor_ato_lei489", nullable = false, precision = 10, scale = 2)
	public BigDecimal getValorAtoLei489() { return valorAtoLei489; }
	public void setValorAtoLei489(BigDecimal valorAtoLei489) {
															this.valorAtoLei489 = valorAtoLei489; }
