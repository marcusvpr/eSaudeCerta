...
//	}
	...
	public MpTabelaInternaSJ porNavegacao(String acao, MpTipoTabelaInternaSJ mpTipoTabelaInternaSJ, String codigo) {
		//
...
//																		 	  " / " + codigo);
		...
		try {
			...
			String order = " ORDER BY ti.mpTipoTabelaInternaSJ";

			if (acao.equals("mpEnd") || acao.equals("mpPrev")) {
				hql += " WHERE ti.mpTipoTabelaInternaSJ < :tipoTabelaInternaSJ AND UPPER(codigo) < :codigo";
...
//
			return manager.createQuery(hql + order, MpTabelaInternaSJ.class)
				.setParameter("tipoTabelaInternaSJ", mpTipoTabelaInternaSJ)
				.setParameter("codigo", codigo.toUpperCase())
